...
// node_modules/svelte-materialify/src/components/Slider/nouislider.min.js
var require_nouislider_min = __commonJS({
  "node_modules/svelte-materialify/src/components/Slider/nouislider.min.js"(exports, module) {
    !function(t) {
      ...
      function l(t, e2, r2) {
        if (e2)
          if (r2.xVal[t] !== r2.xVal[t + 1]) {
            ...
            r2.xSteps[t] = r2.xHighestCompleteStep[t] = r2.xVal[t];
      }
      function i(t, e2, r2) {
        var n2;
        ...
        var i2 = [];
        for (n2 in t)
          t.hasOwnProperty(n2) && i2.push([t[n2], n2]);
      ...
      i.prototype.getDistance = function(t) {
        ...
        if (t < this.xPct[this.xPct.length - 1])
          for (; t > this.xPct[i2 + 1]; )
            i2++;
        else
          t === this.xPct[this.xPct.length - 1] && (i2 = this.xPct.length - 2);
      ...
      function V(t, e2) {
        if (false !== e2)
          if (true === e2) {
            t.tooltips = [];
            for (var r2 = 0; r2 < t.handles; r2++)
              t.tooltips.push(true);
          } else {
          ...
          return V2(n3, b2.cssClasses.touchArea), n3.setAttribute("data-handle", e3), b2.keyboardSupport && (n3.setAttribute("tabindex", "0"), n3.addEventListener("keydown", function(t3) {
            return function(t4, e4) {
              ...
              if (t4.preventDefault(), p3 || c3) {
                ...
                s3 = d3 ? b2.spectrum.xVal[b2.spectrum.xVal.length - 1] : b2.spectrum.xVal[0];
...
//# sourceMappingURL=nouislider.min-BUGXAG25.js.map
