...
function create_default_slot(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & 16 && switch_value !== (switch_value = ctx2[22])) {
        if (switch_instance) {
          group_outros();
...
function create_each_block2(key_1, ctx) {
  ...
  const block = {
    ...
    p: function update(new_ctx, dirty) {
      ...
      if (dirty & 16 && switch_value !== (switch_value = ctx[2])) {
        if (switch_instance) {
          group_outros();
          const old_component = switch_instance;
          transition_out(old_component.$$.fragment, 1, 0, () => {
...
function create_fragment4(ctx) {
  ...
  let prefetcher;
  let current;
  let if_block = ctx[0] && ctx[1] !== null && create_if_block2(ctx);
